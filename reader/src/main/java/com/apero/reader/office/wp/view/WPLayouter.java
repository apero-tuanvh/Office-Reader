...
import com.apero.reader.office.simpletext.view.DocAttr;
import com.apero.reader.office.simpletext.view.IView;
import com.apero.reader.office.simpletext.view.PageAttr;
import com.apero.reader.office.simpletext.view.ParaAttr;
import com.apero.reader.office.simpletext.view.ViewKit;
...
public class WPLayouter {
    ...
    public int layoutPage(PageView pageView) {
        ...
        if (para.getType() == WPViewConstant.TABLE_VIEW && tableLayout.isTableBreakPages()) {
            ...
            Log.e("WPLayouter.layoutPage", "para.getType() = " + "WPViewConstant.TABLE_VIEW and " + (breakPara != null ? "breakPara != null" : "breakPara == null"));
            ...
            Log.e("WPLayouter.layoutPage", "else para.getType() other breakPara " + (breakPara != null ? "breakPara != null" : "breakPara == null"));
        }
    ...
    public boolean isLayoutFinish() {
        ...
        Log.e("WPLAYOUTER", "breakPara " + (breakPara != null ? " != null" : "== null"));
