 ...
 * 时间:              下午6:08:08
 */
package com.apero.reader.office.fc.xls.Reader;
...
import com.apero.reader.office.fc.xls.Reader.drawing.DrawingReader;
import com.apero.reader.office.fc.xls.Reader.table.TableReader;
...
import com.apero.reader.office.ss.model.sheetProperty.ColumnInfo;
...
import com.apero.reader.office.ss.util.ReferenceUtil;
import com.apero.reader.office.system.AbortReaderError;
import com.apero.reader.office.system.IReader;
...
public class SheetReader
{
    ...
    public  void getSheet(IControl control, ZipPackage zipPackage, Sheet sheet, PackagePart  sheetPart, IReader iReader) throws Exception
    {
        ...
        if(ele.element("pane") != null)
        {
           ...
           {
               paneInfo.setVerticalSplitLeftColumn((short) IntUtils.stringToInt(pane.attributeValue("xSplit")));
           }

           if(pane.attributeValue("ySplit") != null)
           {
               paneInfo.setHorizontalSplitTopRow((short) IntUtils.stringToInt((pane.attributeValue("ySplit"))));
           }
    ...
    private void setColumnProperty(Element col)
    {
        ...
        {
            hidden = (IntUtils.stringToInt(col.attributeValue("hidden")) != 0);
        }
        else
        {
            hidden = false;
    ...
    private  Row createRow(Element rowElement, int defaultRowHeight)
    {
        ...
        {
            hidden = (IntUtils.stringToInt(rowElement.attributeValue("hidden")) != 0);
        }
