...
import com.apero.reader.office.fc.ss.usermodel.Comment;
import com.apero.reader.office.fc.ss.usermodel.FormulaError;
...
import com.apero.reader.office.fc.ss.usermodel.RichTextString;
import com.apero.reader.office.fc.ss.util.CellReference;
import com.apero.reader.office.fc.ss.util.HSSFCellRangeAddress;
import com.apero.reader.office.fc.ss.util.NumberToTextConverter;
...
public class HSSFCell implements ICell {
     ...
     *                Type of cell
     * @see HSSFRow#createCell(short,int)
     */
...
//        agg.setParsedExpression(ptgs);
     ...
     * @see HSSFWorkbook#getCellStyleAt(short)
     */
     ...
     * @see HSSFRow#removeCell(com.com.wxiwei.office.fc.ss.usermodel.ICell)
     * @see HSSFSheet#removeRow(org.apache.poi.ss.usermodel.Row)
     * @see HSSFSheet#shiftRows(int, int, int)
     * @see HSSFSheet#addMergedRegion(HSSFCellRangeAddress)
