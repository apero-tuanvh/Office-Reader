...
import com.apero.reader.office.fc.OldFileFormatException;
import com.apero.reader.office.fc.poifs.filesystem.OfficeXmlFileException;
import com.apero.reader.office.res.ResConstant;
...
public class ErrorUtil
{
    ...
    public static final int SYSTEM_PERMISSION = 10;
    //
...
//                            err = control.getMainFrame().getLocalString("DIALOG_CANNOT_ENCRYPTED_FILE");
                            err = control.getMainFrame().getLocalString(ResConstant.sys_can_not_encrytped_file);
                        ...
                        if (err.length() > 0 &&errorCode!=SYSTEM_PERMISSION)
                        {
