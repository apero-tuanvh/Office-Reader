...
package com.apero.reader.office.ss.control;
...
import com.apero.reader.office.ss.model.interfacePart.IReaderListener;
import com.apero.reader.office.ss.util.ModelUtil;
import com.apero.reader.office.ss.view.SheetView;
import com.apero.reader.office.system.IControl;
import com.apero.reader.office.system.IFind;
import com.apero.reader.office.system.ReaderHandler;
import com.apero.reader.office.system.beans.AEventManage;
import com.apero.reader.office.system.beans.CalloutView.CalloutView;
import com.apero.reader.office.system.beans.CalloutView.IExportListener;
...
{  
    ...
    public void showSheet(String sheetName)
    {
        ...
        ModelUtil.instance().clearFormatContentsCellMapOfCurrentSheet();
...
//    }
     ...
     *(non-Javadoc)
     * @see com.apero.reader.office.ss.model.interfacePart.IReaderListener#OnReadingFinished()
     *
     */
