 ...
 * 时间:              上午9:08:14
 */
package com.apero.reader.office.common.pictureefftect;
...
public class PictureEffectInfoFactory
{
    ...
    public static PictureEffectInfo getPictureEffectInfor(com.apero.reader.office.fc.hwpf.usermodel.Picture pic)
    {
    	if(pic == null)
        {
            return null;
