...
public final class TitleMaster extends MasterSheet
{
     ...
     *
     */
    public TitleMaster(com.apero.reader.office.fc.hslf.record.Slide record, int sheetNo)
    {
    ...
    public MasterSheet getMasterSheet()
    {
        ...
        SlideAtom sa = ((com.apero.reader.office.fc.hslf.record.Slide)getSheetContainer()).getSlideAtom();
