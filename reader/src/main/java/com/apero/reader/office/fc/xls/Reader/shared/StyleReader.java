 ...
 * 时间:              下午3:10:35
 */
package com.apero.reader.office.fc.xls.Reader.shared;
...
import com.apero.reader.office.ss.model.sheetProperty.Palette;
import com.apero.reader.office.ss.model.style.BorderStyle;
import com.apero.reader.office.ss.model.style.BuiltinFormats;
import com.apero.reader.office.ss.model.style.CellBorder;
import com.apero.reader.office.ss.model.style.CellStyle;
import com.apero.reader.office.ss.model.style.NumberFormat;
import com.apero.reader.office.ss.model.table.TableFormatManager;
...
{    
    ...
    private void processCellStyleAlignment(CellStyle cellStyle, Element alignment)
    {
        ...
        {
            cellStyle.setWrapText(IntUtils.stringToInt(alignment.attributeValue("wrapText")) != 0);
        }
