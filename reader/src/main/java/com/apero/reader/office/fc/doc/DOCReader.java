...
import com.apero.reader.office.common.bookmark.Bookmark;
...
import com.apero.reader.office.fc.ddf.EscherTextboxRecord;
import com.apero.reader.office.fc.hwpf.HWPFDocument;
import com.apero.reader.office.fc.hwpf.model.FieldsDocumentPart;
import com.apero.reader.office.fc.hwpf.model.ListFormatOverride;
import com.apero.reader.office.fc.hwpf.model.ListTables;
import com.apero.reader.office.fc.hwpf.model.POIListData;
import com.apero.reader.office.fc.hwpf.model.POIListLevel;
import com.apero.reader.office.fc.hwpf.model.PicturesTable;
import com.apero.reader.office.fc.hwpf.usermodel.Bookmarks;
import com.apero.reader.office.fc.hwpf.usermodel.BorderCode;
import com.apero.reader.office.fc.hwpf.usermodel.CharacterRun;
import com.apero.reader.office.fc.hwpf.usermodel.Field;
import com.apero.reader.office.fc.hwpf.usermodel.HWPFAutoShape;
import com.apero.reader.office.fc.hwpf.usermodel.HWPFShape;
import com.apero.reader.office.fc.hwpf.usermodel.HWPFShapeGroup;
import com.apero.reader.office.fc.hwpf.usermodel.HeaderStories;
import com.apero.reader.office.fc.hwpf.usermodel.InlineWordArt;
import com.apero.reader.office.fc.hwpf.usermodel.LineSpacingDescriptor;
import com.apero.reader.office.fc.hwpf.usermodel.OfficeDrawing;
import com.apero.reader.office.fc.hwpf.usermodel.OfficeDrawings;
import com.apero.reader.office.fc.hwpf.usermodel.POIBookmark;
import com.apero.reader.office.fc.hwpf.usermodel.Paragraph;
import com.apero.reader.office.fc.hwpf.usermodel.PictureType;
import com.apero.reader.office.fc.hwpf.usermodel.Range;
import com.apero.reader.office.fc.hwpf.usermodel.Section;
import com.apero.reader.office.fc.hwpf.usermodel.Table;
import com.apero.reader.office.fc.hwpf.usermodel.TableCell;
import com.apero.reader.office.fc.hwpf.usermodel.TableRow;
import com.apero.reader.office.fc.util.LittleEndian;
import com.apero.reader.office.java.awt.Rectangle;
import com.apero.reader.office.java.util.Arrays;
...
import com.apero.reader.office.simpletext.view.PageAttr;
    ...
    private BackgroundAndFill converFill(HWPFAutoShape shape, OfficeDrawing drawing, int shapeType)
    {
        ...
        if (shape != null)
        {
            		...
            		|| type == BackgroundAndFill.FILL_SHADE_RECT || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	com.apero.reader.office.java.awt.Color fillColor = shape.getForegroundColor();
            	com.apero.reader.office.java.awt.Color fillbackColor = shape.getFillbackColor();
   ...
   /*         	byte[] data = drawing.getBGPictureData(shape.getBackgroundPictureIdx());
    ...
    private void processWordArtTextbox(EscherContainerRecord escherContainer, WPAutoShape autoShape)
    {
		...
		if(text != null && text.length() > 0)
		{
            ...
            // 字符颜色
            com.apero.reader.office.java.awt.Color color = ShapeKit.getForegroundColor(escherContainer, null, MainConstant.APPLICATION_TYPE_PPT);
            if(color != null)
            {
    ...
    private boolean processShape(CharacterRun run, IElement leaf, boolean isWrap, int runIndex)
    {
        ...
        else
        {
            ...
            com.apero.reader.office.fc.hwpf.usermodel.Picture pic = pictureTable.extractPicture(control.getSysKit().getPictureManage().getPicTempPath(),
                run, false);
