 ...
 * 时间:              下午3:23:24
 */
package com.apero.reader.office.ss.util;
...
public class ModelUtil
{
    ...
    private final Map<Integer, String> formatContentsOfCell = new HashMap<>();

    public void clearFormatContentsCellMapOfCurrentSheet() {
        formatContentsOfCell.clear();
    }
    /**
     *
     * @param cell
    ...
    {
        int cellIndex = cell.getRowNumber() + cell.getColNumber();
        if (formatContentsOfCell.containsKey(cellIndex)) {
            return formatContentsOfCell.get(cellIndex);
        }
        //
        ...
        formatContentsOfCell.put(cellIndex, value);
        return value;
    }
}
