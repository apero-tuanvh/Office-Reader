...
import com.apero.reader.office.fc.ss.usermodel.IFont;
 ...
 * @see HSSFCell#setCellStyle(HSSFCellStyle)
 */
public final class HSSFCellStyle implements ICellStyle {
     ...
     * @return the format string or "General" if not found
     */
    public String getDataFormatString(com.apero.reader.office.fc.ss.usermodel.Workbook workbook) {
...
//        return format.getFormat(getDataFormat());
     ...
     * @see HSSFWorkbook#getFontAt(short)
     */
     ...
     * @see HSSFCellStyle#getFontIndex()
     * @see HSSFWorkbook#getFontAt(short)
     */
    public HSSFFont getFont(com.apero.reader.office.fc.ss.usermodel.Workbook parentWorkbook) {
    ...
    private void checkDefaultBackgroundFills() {
      if (_format.getFillForeground() == HSSFColor.AUTOMATIC.index) {
    	  ...
    	  if (_format.getFillBackground() != (HSSFColor.AUTOMATIC.index+1))
    		  setFillBackgroundColor((short)(HSSFColor.AUTOMATIC.index+1));
      } else if (_format.getFillBackground() == HSSFColor.AUTOMATIC.index+1)
    	  //Now if the forground changes to a non-AUTOMATIC color the background resets itself!!!
    	  if (_format.getFillForeground() != HSSFColor.AUTOMATIC.index)
    		  setFillBackgroundColor(HSSFColor.AUTOMATIC.index);
    }
