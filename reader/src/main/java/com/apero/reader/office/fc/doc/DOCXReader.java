...
import com.apero.reader.office.fc.openxml4j.exceptions.InvalidFormatException;
...
public class DOCXReader extends AbstractReader
{
    ...
    private void openFile() throws Exception
    {
        ...
        /*if (isPropertiesFileError(doc.getRootElement().element("body").element("sectPr"))) {
    ...
    private boolean isPropertiesFileError(Element body) {
        int left= 0, right = 0, top = 0, bottom = 0;
        Element margin = body.element("pgMar");
        if (margin != null) {
            if (margin.attributeValue("left") != null) {
                left = IntUtils.stringToInt(margin.attributeValue("left"));
            }
            if (margin.attributeValue("right") != null) {
                right = IntUtils.stringToInt(margin.attributeValue("right"));
            }
            if (margin.attributeValue("top") != null) {
                top = IntUtils.stringToInt(margin.attributeValue("top"));
            }
            if (margin.attributeValue("bottom") != null) {
                bottom = IntUtils.stringToInt(margin.attributeValue("bottom"));
            }
        }
    ...
    private void processListLevel(ListLevel level, Element elem)
    {
        ...
        if (temp != null)
        {
            ...
            if (temp != null)
            {
                ...
                if (val != null)
                {
                    level.setTextIndent(IntUtils.stringToInt(val));
                }
            }
        }
    }
    ...
    private void processSection(Element body) throws Exception
    {
        ...
        Log.e("DOCREADER", "processSection offset = " + offset);
    ...
    private void processSectionAttribute(Element sectPr)
    {
        ...
        if (pgSz != null)
        {
            ...
            AttrManage.instance().setPageWidth(attr,
                    IntUtils.stringToInt(pgSz.attributeValue("w")));
            // 高度
            AttrManage.instance().setPageHeight(attr,
                    IntUtils.stringToInt(pgSz.attributeValue("h")));
            Log.e("DOCX reader", "width = " + IntUtils.stringToInt(pgSz.attributeValue("w")));
            Log.e("DOCX reader", "height = " + IntUtils.stringToInt(pgSz.attributeValue("h")));
        }
        else {
            AttrManage.instance().setPageWidth(attr,
                    816);
...
//                    15840);
        ...
        if (margin != null)
        {
            ...
            if (margin.attributeValue("left") != null) {
                ...
                Log.e("setPageMarginLeft", "" + Integer.parseInt(margin.attributeValue("left")));
            }
//            else {
//                AttrManage.instance().setPageMarginLeft(attr,
//                        1440);
//            }
            if (margin.attributeValue("right") != null) {
                ...
                Log.e("setPageMarginRight", "" + Integer.parseInt(margin.attributeValue("right")));
            }
//            else {
//                AttrManage.instance().setPageMarginRight(attr,
//                        1440);
//            }
            if (margin.attributeValue("top") != null) {
                ...
                Log.e("setPageMarginTop", "" + Integer.parseInt(margin.attributeValue("top")));
            }
//            else {
//                AttrManage.instance().setPageMarginTop(attr,
//                        1440);
//            }
            if (margin.attributeValue("bottom") != null) {
                ...
                Log.e("setPageMarginBottom", "" + Integer.parseInt(margin.attributeValue("bottom")));
            }
//            else {
//                AttrManage.instance().setPageMarginBottom(attr,
//                        1440);
//            }
    ...
    private void processTable(Element table)
    {
        ...
        if (tblGrid != null)
        {
            ...
            if (grids != null)
            {
                ...
                {
                    tableGridCol.put(i, IntUtils.stringToInt(grids.get(i).attributeValue("w")));
                }
            }
        }
    ...
    private void processTableAttribute(Element tblPr, IAttributeSet attr)
    {
        ...
        if (temp != null)
        {
            ...
            if (val != null)
            {
                AttrManage.instance().setParaIndentLeft(attr, IntUtils.stringToInt(val));
            }
        }
    ...
    private int processCellAttribute(Element tcPr, IAttributeSet attr, int gridColIndex)
    {
        ...
        if (temp != null)
        {
            int w = IntUtils.stringToInt(temp.attributeValue("w"));
            ...
            {   
                ...
                {
                    //Fix Attempt to invoke virtual method 'int java.lang.Integer.intValue()' on a null object reference
                    if (tableGridCol != null && tableGridCol.get(i) != null) {
    ...
    private void processParaAttribute(Element pPr, IAttributeSet attr, int level)
    {
     ...
     // 样式
        ...
        if (temp != null)
        {
            ...
            if (val != null)
            {
                int lineUnit = (int) Double.parseDouble(val);
                // 默认行单位是12磅
        ...
        if (temp != null)
        {
            ...
            Style style = null;
            try {
                style = StyleManage.instance().getStyle(styleStrID.get("docDefaults"));
            } catch (Exception e) {
                style = null;
            }
        	if(style != null)
            ...
            else if((val = temp.attributeValue("right")) != null)
            {
            	if (val.length() > 0)
                {
                    AttrManage.instance().setParaIndentRight(attr, IntUtils.stringToInt(val));
                }
            }
    ...
    private void processRunAttribute(Element rPr, IAttributeSet attr)
    {
        ...
        if (u != null)
        {
        	...
        	if(underlineType != null)
        	{
                ...
                {
                    try {
                        AttrManage.instance().setFontUnderlineColr(attr, Color.parseColor("#" + val));
