...
import com.apero.reader.office.fc.hpsf.DocumentSummaryInformation;
import com.apero.reader.office.fc.hpsf.MutablePropertySet;
import com.apero.reader.office.fc.hpsf.PropertySet;
import com.apero.reader.office.fc.hpsf.PropertySetFactory;
import com.apero.reader.office.fc.hpsf.SummaryInformation;
...
import com.apero.reader.office.fc.poifs.filesystem.DocumentInputStream;
import com.apero.reader.office.fc.poifs.filesystem.Entry;
import com.apero.reader.office.fc.poifs.filesystem.NPOIFSFileSystem;
...
import com.apero.reader.office.fc.util.POIUtils;
...
public abstract class POIDocument
{
    ...
    protected PropertySet getPropertySet(String setName)
    {
        ...
        catch(com.apero.reader.office.fc.hpsf.HPSFException he)
        {
            // Oh well, doesn't exist
            logger.log(POILogger.WARN, "Error creating property set with name " + setName + "\n"
                + he);
        ...
        throws IOException
    {
        ...
        catch(com.apero.reader.office.fc.hpsf.WritingNotSupportedException wnse)
        {
