...
import com.apero.reader.office.common.ICustomDialog;
import com.apero.reader.office.common.IOfficeToPicture;
import com.apero.reader.office.common.ISlideShow;
...
import com.apero.reader.office.fc.doc.TXTKit;
import com.apero.reader.office.fc.pdf.PDFLib;
import com.apero.reader.office.macro.OnOpenFileListener;
import com.apero.reader.office.pdf.PDFControl;
import com.apero.reader.office.pg.control.PGControl;
import com.apero.reader.office.pg.model.PGModel;
import com.apero.reader.office.simpletext.model.IDocument;
import com.apero.reader.office.ss.control.SSControl;
import com.apero.reader.office.ss.model.baseModel.Workbook;
import com.apero.reader.office.wp.control.WPControl;
                ...
                switch (msg.what)
                {
                    ...
                    case MainConstant.HANDLER_MESSAGE_ERROR:
                        post(new Runnable()
                        {
                            ...
                            {
                                if (onOpenFileListener != null) {
                                    onOpenFileListener.onOpenFileFailure(message.obj.toString());
                                }
                                dismissProgressDialog();
...
//                                frame.getActivity().setProgressBarIndeterminateVisibility(false);
    ...
    {      
        ...
        {
            try {
                if (reader.getModel() != null) {
                    if (reader.getModel() instanceof Workbook) {
                        ((Workbook) reader.getModel()).dispose();
                    }
                }
            } catch (Exception e) {
                e.printStackTrace();
    ...
    public void setOpenFileListener(OnOpenFileListener listener) {
