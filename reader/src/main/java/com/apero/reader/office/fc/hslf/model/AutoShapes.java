...
public final class AutoShapes
{
     ...
     *
    */
    public static com.apero.reader.office.java.awt.Shape transform(com.apero.reader.office.java.awt.Shape outline, Rectangle2D anchor)
    {
    ...
    static
    {
        ...
        {
            public com.apero.reader.office.java.awt.Shape getOutline(Shape shape)
            {
