...
import com.apero.reader.office.thirdpart.achartengine.renderers.BasicStroke;
...
import com.apero.reader.office.thirdpart.achartengine.renderers.XYMultipleSeriesRenderer.Orientation;
...
public abstract class XYChart extends AbstractChart {
   ...
   * 
   *(non-Javadoc)
   * @see AbstractChart#setZoomRate(float)
   *
   */
  @Override
