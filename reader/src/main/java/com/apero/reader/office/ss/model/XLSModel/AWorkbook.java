...
import com.apero.reader.office.fc.xls.SSReader;
import com.apero.reader.office.simpletext.font.Font;
...
import com.apero.reader.office.ss.util.ColorUtil;
import com.apero.reader.office.system.AbstractReader;
import com.apero.reader.office.system.IControl;
import com.apero.reader.office.system.ReaderHandler;
 ...
 * <p>
 */
public class AWorkbook extends Workbook implements com.apero.reader.office.fc.ss.usermodel.Workbook
{
        ...
        public void run()
        {
            ...
            { 
                ...
                if (iAbortListener != null) {
                    iAbortListener.dispose();
                    if (iAbortListener.getControl() != null) {
                        iAbortListener.getControl().getSysKit().getErrorKit().writerLog(e, true);
                    }
                }
            } 
     ...
     * @see LabelRecord
     * @see com.apero.reader.office.fc.hssf.record.LabelSSTRecord
     * @see com.apero.reader.office.fc.hssf.record.SSTRecord
     */
