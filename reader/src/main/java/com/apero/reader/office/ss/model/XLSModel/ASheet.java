 ...
 * 时间:              下午1:55:20
 */
package com.apero.reader.office.ss.model.XLSModel;
...
import com.apero.reader.office.common.shape.AChart;
...
import com.apero.reader.office.constant.SSConstant;
import com.apero.reader.office.fc.hssf.model.InternalSheet;
import com.apero.reader.office.fc.hssf.model.InternalWorkbook;
import com.apero.reader.office.fc.hssf.record.BlankRecord;
...
import com.apero.reader.office.fc.hssf.usermodel.HSSFAutoShape;
import com.apero.reader.office.fc.hssf.usermodel.HSSFChart;
import com.apero.reader.office.fc.hssf.usermodel.HSSFChildAnchor;
import com.apero.reader.office.fc.hssf.usermodel.HSSFClientAnchor;
import com.apero.reader.office.fc.hssf.usermodel.HSSFFreeform;
import com.apero.reader.office.fc.hssf.usermodel.HSSFLine;
import com.apero.reader.office.fc.hssf.usermodel.HSSFPatriarch;
import com.apero.reader.office.fc.hssf.usermodel.HSSFPicture;
import com.apero.reader.office.fc.hssf.usermodel.HSSFPictureData;
import com.apero.reader.office.fc.hssf.usermodel.HSSFRichTextString;
import com.apero.reader.office.fc.hssf.usermodel.HSSFShape;
import com.apero.reader.office.fc.hssf.usermodel.HSSFShapeGroup;
import com.apero.reader.office.fc.hssf.usermodel.HSSFSheet;
import com.apero.reader.office.fc.hssf.usermodel.HSSFTextbox;
import com.apero.reader.office.fc.hssf.usermodel.HSSFWorkbook;
...
import com.apero.reader.office.fc.xls.ChartConverter;
...
import com.apero.reader.office.ss.model.baseModel.Row;
import com.apero.reader.office.ss.model.baseModel.Sheet;
import com.apero.reader.office.ss.model.baseModel.Workbook;
import com.apero.reader.office.ss.model.drawing.AnchorPoint;
import com.apero.reader.office.ss.model.drawing.CellAnchor;
import com.apero.reader.office.ss.model.sheetProperty.PaneInformation;
import com.apero.reader.office.ss.util.ModelUtil;
import com.apero.reader.office.ss.util.SectionElementFactory;
...
import com.apero.reader.office.thirdpart.achartengine.chart.RoundChart;
import com.apero.reader.office.thirdpart.achartengine.chart.XYChart;
import com.apero.reader.office.thirdpart.achartengine.renderers.DefaultRenderer;
 ...
 * <p>
 */
public class ASheet extends Sheet implements com.apero.reader.office.fc.ss.usermodel.Sheet
{
    ...
    protected ASheet(AWorkbook workbook, InternalSheet sheet)
    {
        ...
        List<com.apero.reader.office.fc.hssf.util.ColumnInfo> hssfColumnInfoList = sheet.getColumnInfo();
        if(hssfColumnInfoList != null)
        {
            Iterator<com.apero.reader.office.fc.hssf.util.ColumnInfo> iter = hssfColumnInfoList.iterator();
            while(iter.hasNext())
            {
                com.apero.reader.office.fc.hssf.util.ColumnInfo hssfColumnInfo = iter.next();
                com.apero.reader.office.ss.model.sheetProperty.ColumnInfo columnInfo = new com.apero.reader.office.ss.model.sheetProperty.ColumnInfo(
