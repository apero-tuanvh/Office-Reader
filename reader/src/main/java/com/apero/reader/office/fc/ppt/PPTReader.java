 ...
 * 时间:               下午4:23:51
 */
package com.apero.reader.office.fc.ppt;
...
import com.apero.reader.office.common.bg.LinearGradientShader;
import com.apero.reader.office.common.bg.RadialGradientShader;
import com.apero.reader.office.common.bg.TileShader;
import com.apero.reader.office.common.hyperlink.Hyperlink;
...
import com.apero.reader.office.common.shape.ArbitraryPolygonShape;
import com.apero.reader.office.common.shape.Arrow;
...
import com.apero.reader.office.common.shape.LineShape;
import com.apero.reader.office.common.shape.PictureShape;
import com.apero.reader.office.common.shape.ShapeTypes;
import com.apero.reader.office.common.shape.TableCell;
import com.apero.reader.office.common.shape.TableShape;
import com.apero.reader.office.common.shape.TextBox;
import com.apero.reader.office.constant.AutoShapeConstant;
import com.apero.reader.office.constant.EventConstant;
import com.apero.reader.office.constant.MainConstant;
import com.apero.reader.office.constant.wp.WPAttrConstant;
...
import com.apero.reader.office.fc.hslf.HSLFSlideShow;
import com.apero.reader.office.fc.hslf.model.Fill;
import com.apero.reader.office.fc.hslf.model.HeadersFooters;
import com.apero.reader.office.fc.hslf.model.Line;
import com.apero.reader.office.fc.hslf.model.MasterSheet;
import com.apero.reader.office.fc.hslf.model.Notes;
import com.apero.reader.office.fc.hslf.model.Shape;
import com.apero.reader.office.fc.hslf.model.ShapeGroup;
import com.apero.reader.office.fc.hslf.model.Sheet;
import com.apero.reader.office.fc.hslf.model.SimpleShape;
import com.apero.reader.office.fc.hslf.model.Slide;
import com.apero.reader.office.fc.hslf.model.SlideMaster;
import com.apero.reader.office.fc.hslf.model.TextShape;
import com.apero.reader.office.fc.hslf.model.TitleMaster;
import com.apero.reader.office.fc.hslf.record.BinaryTagDataBlob;
import com.apero.reader.office.fc.hslf.record.ClientVisualElementContainer;
import com.apero.reader.office.fc.hslf.record.DocumentAtom;
import com.apero.reader.office.fc.hslf.record.OEPlaceholderAtom;
import com.apero.reader.office.fc.hslf.record.PositionDependentRecordContainer;
import com.apero.reader.office.fc.hslf.record.Record;
import com.apero.reader.office.fc.hslf.record.SlideAtom;
import com.apero.reader.office.fc.hslf.record.SlideProgBinaryTagContainer;
...
import com.apero.reader.office.fc.hslf.record.TimeAnimateBehaviorContainer;
import com.apero.reader.office.fc.hslf.record.TimeBehaviorContainer;
import com.apero.reader.office.fc.hslf.record.TimeColorBehaviorContainer;
import com.apero.reader.office.fc.hslf.record.TimeCommandBehaviorContainer;
import com.apero.reader.office.fc.hslf.record.TimeEffectBehaviorContainer;
import com.apero.reader.office.fc.hslf.record.TimeMotionBehaviorContainer;
import com.apero.reader.office.fc.hslf.record.TimeNodeAttributeContainer;
import com.apero.reader.office.fc.hslf.record.TimeNodeContainer;
import com.apero.reader.office.fc.hslf.record.TimeRotationBehaviorContainer;
import com.apero.reader.office.fc.hslf.record.TimeScaleBehaviorContainer;
import com.apero.reader.office.fc.hslf.record.TimeSetBehaviorContainer;
import com.apero.reader.office.fc.hslf.record.TimeVariant;
import com.apero.reader.office.fc.hslf.record.VisualShapeAtom;
import com.apero.reader.office.fc.hslf.record.SlideAtom.SSlideLayoutAtom;
import com.apero.reader.office.fc.hslf.usermodel.PictureData;
import com.apero.reader.office.fc.hslf.usermodel.RichTextRun;
import com.apero.reader.office.fc.hslf.usermodel.SlideShow;
import com.apero.reader.office.fc.ppt.bulletnumber.BulletNumberManage;
import com.apero.reader.office.java.awt.Dimension;
import com.apero.reader.office.java.awt.Rectangle;
import com.apero.reader.office.java.awt.Rectanglef;
import com.apero.reader.office.java.awt.geom.Rectangle2D;
import com.apero.reader.office.pg.animate.ShapeAnimation;
import com.apero.reader.office.pg.model.PGModel;
import com.apero.reader.office.pg.model.PGNotes;
import com.apero.reader.office.pg.model.PGSlide;
...
import com.apero.reader.office.ss.util.format.NumericFormatter;
import com.apero.reader.office.system.AbstractReader;
import com.apero.reader.office.system.BackReaderThread;
...
{   
    ...
    private com.apero.reader.office.common.borders.Line getShapeLine(SimpleShape shape)
    {
    	return getShapeLine(shape, false);
    }
    
    private com.apero.reader.office.common.borders.Line getShapeLine(SimpleShape shape, boolean isTableCellLine)
    {
        com.apero.reader.office.common.borders.Line line = null;
        if(shape != null && shape.hasLine())
        {
             ...
             com.apero.reader.office.java.awt.Color color = ((SimpleShape)shape).getLineColor();
             
             if(color != null)
             {
            	 line = new com.apero.reader.office.common.borders.Line();
    ...
    private BackgroundAndFill converFill(PGSlide pgSlide, Fill fill)
    {
        ...
        {        	
                    ...
                    || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	com.apero.reader.office.java.awt.Color fillColor = fill.getForegroundColor();
            	com.apero.reader.office.java.awt.Color fillbackColor = fill.getFillbackColor();
    ...
    private void processNotes(PGSlide pgSlide, Notes notes)
    {
        if (notes != null)
        {
            ...
            for (Shape shape : notes.getShapes())
            {
                ...
                if(shape instanceof com.apero.reader.office.fc.hslf.model.AutoShape  // 文本框
                    || shape instanceof com.apero.reader.office.fc.hslf.model.TextBox)  // 占位符
                {
...
//        }
        ...
        if (shape instanceof Line
            || shape instanceof com.apero.reader.office.fc.hslf.model.Freeform
            || shape instanceof com.apero.reader.office.fc.hslf.model.AutoShape
            || shape instanceof com.apero.reader.office.fc.hslf.model.TextBox
            || shape instanceof com.apero.reader.office.fc.hslf.model.Picture)
        {  
            if (shape instanceof Line)
            {
                if (line != null)
            ...
            else if(shape instanceof com.apero.reader.office.fc.hslf.model.Freeform)
            {              
                if (fill != null || line != null)
                {
                    ...
                    if (startArrowType > 0)
                    {
                    	ArrowPathAndTail arrowPathAndTail = ((com.apero.reader.office.fc.hslf.model.Freeform)shape).getStartArrowPathAndTail(rect);
                    ...
                    if (endArrowType > 0)
                    {                        
                    	ArrowPathAndTail arrowPathAndTail = ((com.apero.reader.office.fc.hslf.model.Freeform)shape).getEndArrowPathAndTail(rect);
                    	if(arrowPathAndTail != null && arrowPathAndTail.getArrowPath() != null)
                        {
                    ...
                    Path[] paths = ((com.apero.reader.office.fc.hslf.model.Freeform)shape).getFreeformPath(rect,
            ...
            else if(shape instanceof com.apero.reader.office.fc.hslf.model.AutoShape
                    || shape instanceof com.apero.reader.office.fc.hslf.model.TextBox)
            {
                // autoShape
            ...
            // 图片
            else if(shape instanceof com.apero.reader.office.fc.hslf.model.Picture)
            {   
                com.apero.reader.office.fc.hslf.model.Picture poiPic = (com.apero.reader.office.fc.hslf.model.Picture)shape;
        ...
        else if(shape instanceof com.apero.reader.office.fc.hslf.model.Table)
        {
            com.apero.reader.office.fc.hslf.model.Table poiTable = (com.apero.reader.office.fc.hslf.model.Table)shape;
            if (poiTable != null)
            {
     ...
     * @param pgSlide
     */
    private void processTable(PGSlide pgSlide, com.apero.reader.office.fc.hslf.model.Table poiTable, GroupShape parent, int slideType)
    {
        ...
        for (int i = 0; i < rows; i++)
        {
            for (int j = 0; j < columns; j++)
            {
                ...
                com.apero.reader.office.fc.hslf.model.TableCell poiCell = poiTable.getCell(i, j);
                if (poiCell != null)
                {
        ...
        {
        	com.apero.reader.office.common.borders.Line aLine = getShapeLine(line, true);
            if (aLine != null)
            {
    ...
    private int getBorderColor(Line line)
    {
        if (line != null)
        {
            com.apero.reader.office.java.awt.Color color = line.getLineColor();
            if (color != null)
            {
    ...
    private void processNormalTextShape(TextBox tb, TextShape ts, Rectangle rect, int slideType, int placeHolderID)
    {
        ...
        if (text != null && text.trim().length() > 0)
        {
            ...
            int len = text.length();
            com.apero.reader.office.fc.hslf.model.Hyperlink[] links = ts.getTextRun().getHyperlinks();
            int start = 0;
            // title type just a paragraph needs be processed specially
            if (ts.getTextRun().getRunType() != com.apero.reader.office.fc.hslf.record.TextHeaderAtom.TITLE_TYPE)
            {
                for (int i = 0; i < len; i++)
                {
                    if (abortReader)
    ...
    private void processParagraph(SectionElement secElem, TextShape ts, String text,
                                  com.apero.reader.office.fc.hslf.model.Hyperlink[] links, int start, int end, int placeHolderID)
    {
        ...
        com.apero.reader.office.fc.hslf.record.TextRulerAtom ruler = ts.getTextRun().getTextRuler();
        if (ruler != null)
        {
...
//      }
     ...
     * 
     */
    private int converterColor(com.apero.reader.office.java.awt.Color color)
    {
//        if(color.getAlpha() == 0)
//        {
