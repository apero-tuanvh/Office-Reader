...
public class SysFrame extends LinearLayout
{
    ...
    private void initVertical(Resources res)
    {
        ...
        // 搜索
        BitmapFactory.decodeResource(res, R.drawable.ic_action_search, opts);
        AImageButton search = new AImageButton(context, control, "",  R.drawable.ic_action_search, -1, EventConstant.SYS_SEARCH_ID);
        search.setPushBgResID(R.drawable.bg_dialog);
