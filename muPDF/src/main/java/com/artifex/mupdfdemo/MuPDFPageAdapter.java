    ...
    public View getView(final int position, final View convertView, final ViewGroup parent) {
        ...
        if (convertView == null) {
            if (this.mSharedHqBm == null || this.mSharedHqBm.getWidth() != parent.getWidth() || this.mSharedHqBm.getHeight() != parent.getHeight()) {
                ...
                try{
                    this.mSharedHqBm = Bitmap.createBitmap(parent.getWidth(), parent.getHeight() + 100, Bitmap.Config.ARGB_8888);
                }
                catch (Exception e){
                    e.getStackTrace();
                }
        ...
        if (pageSize != null) {
            ...
            final AsyncTask<Void, Void, PointF> sizingTask = new AsyncTask<Void, Void, PointF>() {
                ...
                protected void onPostExecute(final PointF result) {
                    super.onPostExecute((PointF) result);
                    MuPDFPageAdapter.this.mPageSizes.put(position, (PointF) result);
