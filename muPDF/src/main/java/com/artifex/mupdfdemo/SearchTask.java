...
//                    alert.setButton(-1, (CharSequence)SearchTask.this.mContext.getString(R.string.no_match_found), (DialogInterface.OnClickListener)null);
//                    alert.show();
                    Toast.makeText(mContext, mContext.getString(R.string.no_match_found) , Toast.LENGTH_SHORT).show();
                }
            }
